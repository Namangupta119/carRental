...
const Footer = () => {
  return (
   <motion.div initial={{opacity: 0, y: 30}} whileInView={{opacity: 1, y: 0}} transition={{duration: 0.6}} className='px-6 md:px-16 lg:px-24 xl:px-32 mt-60 text-sm text-grey-500'>
            <motion.div initial={{opacity: 0, y: 20}} whileInView={{opacity: 1, y: 0}} transition={{duration: 0.6, delay: 0.2}} className='flex flex-wrap justify-between  items-start gap-8 pb-6 border-borderColor border-b'>
                <div >
                    ...
                    <motion.p initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration: 0.5, delay: 0.4}} className='max-w-80 mt-3'>
                      Premium car rental service with a wide selectioon of luxury and everyday vehicles for all your driving needs.
                    </motion.p>
                   ...
                   <a href="#"><img src={assets.facebook_logo} className='w5
                   h-5' alt="" /></a>
                   <a href="#"><img src={assets.instagram_logo} className='w5
                   h-5' alt="" /></a>
                   <a href="#"><img src={assets.twitter_logo} className='w5
                   h-5' alt="" /></a>
                   <a href="#"><img src={assets.gmail_logo} className='w5
                   h-5' alt="" /></a> 
                    </motion.div>
                </div>
